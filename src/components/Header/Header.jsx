...
const messages = [
    ...
    },
    {
        ...
        variant: "success",
        name: "Loly",
        message: "Check out my new Newsfeed",
        time: "9:18"
    },
    {
        id: 2,
    ...
    },
    {
        ...
        variant: "secondary",
        name: "Liana",
        message: "Good news from sale deparment",
        time: "13:12",
    }
];
...
const notifications = [
    ...
    },
    {
        ...
        color: "success",
        type: "info",
        message: "What is the best way to get 10 points",
    },
    {
        id: 2,
        color: "secondary",
            ...
            <Toolbar className={classes.toolbar}>
                ...
                >
                    <Badge
                        ...
                        color="warning"
                    >
                        <NotificationsIcon classes={{root: classes.headerIcon}}/> </Badge>
                </IconButton>
                <IconButton
                    color="inherit"
                    aria-haspopup="true"
                ...
                >
                    ...
                    {messages.map(message => (
                        <MenuItem key={message.id} className={classes.messageNotification}>
                            ...
                            >
                                <Typography weight="medidum" gutterBottom>
                                    {message.name}
                                </Typography>
